...
#figure(
  ...
  caption: [Étude 21.10: symbolic quartic oscillator on the line. *Left*: secular determinant $D(E)$ on $[0, 50]$ with the five numerical roots (coral crosses) overlaid on the Bender--Orszag reference values (teal circles) for the five lowest even-parity eigenvalues $E_n, thin n = 0, 2, 4, 6, 8$. *Right*: relative error per mode index. The lower three modes ($E_0, E_2, E_4$) are accurate to $0.5%, 2.7%, 6.9%$ --- usable for a five-term symbolic approximation. The upper two modes ($E_6, E_8$) are *numerical mirages* of the truncation: $E_6$ has $142%$ relative error, $E_8$ has $1790%$ relative error, both wholly worthless. *Trust the lower spectrum first.*],
) <fig-st-quartic>
