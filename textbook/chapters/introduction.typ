...
Finally, this book is an experiment in reproducible science @Donoho2009. The days of presenting numerical results as static, unverifiable images are passing. The results you see in these pages were generated by the code available in the accompanying repository. We utilize a dual-language approach:
...
+ *Global coupling*: Spectral methods compute derivatives using information from _every_ grid point, making them holistic rather than myopic. This global dependence produces dense matrices, but the small number of degrees of freedom required keeps the total cost low.
