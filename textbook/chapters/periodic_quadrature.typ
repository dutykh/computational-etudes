...
#emph[This section is reserved for a non-exhaustive literature overview to be added in a second iteration.] The plan is to trace the periodic trapezoidal rule from Poisson's 1820s computations, through the work of Davis @Davis1959, Goodwin @Goodwin1949, and Stenger on the real line, to the modern synthesis by Trefethen and Weideman @TrefethenWeideman2014 and the follow-up applications surveyed in @Trefethen2016Quadrature. References supplied by the user will be integrated here in a second pass.
