...
for n = 0:4
    ...
    % Plot exact on fine grid and numerical on spectral grid
...
plot(nan, nan, 'o', 'Color', [0.4 0.4 0.4], 'MarkerSize', 4, 'DisplayName', 'Spectral');
...
fprintf('\n======================================================================\n');
fprintf('Harmonic Oscillator Eigenvalue Convergence (Fourier method)\n');
...
%% Helper function: solve harmonic oscillator using periodic spectral method
